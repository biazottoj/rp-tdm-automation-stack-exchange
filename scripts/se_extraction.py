...
def se_execute_extraction():
    data_files = {
        "posts": {"archive_path": "softwareengineering.stackexchange.com.7z", "xml_filename": "Posts.xml"},
        "comments": {"archive_path": "softwareengineering.stackexchange.com.7z", "xml_filename": "Comments.xml"},
        "posthistory": {"archive_path": "softwareengineering.stackexchange.com.7z", "xml_filename": "PostHistory.xml"}
    }

    os.makedirs(archives_dir := "../seData/", exist_ok=True)
    os.makedirs(output_dir := "../seOutput/", exist_ok=True)
